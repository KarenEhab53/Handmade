          ...
          <div className="slide-content">
            ...
            <div className="slide-text">
              ...
              <div className="buttons">
                <button className="hero-btn" onClick={() => goToCategory("Yarn")}>Shop Yarn</button>
                <button className="hero-btn" onClick={() => goToCategory("All")}>View All Products</button>
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className="slide-content">
            ...
            <div className="slide-text">
              ...
              <div className="buttons">
                <button className="hero-btn" onClick={() => goToCategory("Satin Bouquets")}>Order Bouquets</button>
                <button className="hero-btn" onClick={() => goToCategory("All")}>View Collections</button>
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className="slide-content">
            ...
            <div className="slide-text">
              ...
              <div className="buttons">
                <button className="hero-btn" onClick={() => goToCategory("Loly Bags")}>Shop Bags</button>
